...
const { requireAuth, requireAdmin, requireRole } = setupAuth(app, pool, mailTransporter);
...
// ─── MAIL ─────────────────────────────────────────────────────────────
// (mailTransporter se define más arriba, antes de setupAuth, para inyectarlo al 2FA del auth)
